...
import com.example.wangheng2.ak47.okhttp.digest.util.BasicHeaderValueFormatter;
import com.example.wangheng2.ak47.okhttp.digest.util.BasicHeaderValueParser;
import com.example.wangheng2.ak47.okhttp.digest.util.BasicNameValuePair;
import com.example.wangheng2.ak47.okhttp.digest.util.CharArrayBuffer;
import com.example.wangheng2.ak47.okhttp.digest.util.HeaderElement;
import com.example.wangheng2.ak47.okhttp.digest.util.HttpEntityDigester;
import com.example.wangheng2.ak47.okhttp.digest.util.NameValuePair;
import com.example.wangheng2.ak47.okhttp.digest.util.ParserCursor;
import com.example.wangheng2.ak47.okhttp.digest.util.UnsupportedDigestAlgorithmException;
...
public class DigestAuthenticator implements CachingAuthenticator {
    ...
    private String getHeaderName(int httpStatus) {
        if (httpStatus == 401 || httpStatus == 420) {
            setProxy(false);
            return WWW_AUTH;
        }
        if (httpStatus == 407) {
